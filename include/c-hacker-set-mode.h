...
#define CH_ERROR(msg,file_name,line_num,value_str,code,a,b)  _CH_L_ERROR(msg,file_name,line_num,value_str,code,a,b)
...
#define CH_ERROR(msg,file_name,line_num,value_str,code,a,b)  _CH_S_ERROR(msg,file_name,line_num,value_str,code,a,b)
...
#define CH_ERROR(msg,file_name,line_num,value_str,code,a,b)  _CH_SI_ERROR(msg,file_name,line_num,value_str,code,a,b)
